...
export const DesktopHero = () => {
  ...
  useGSAP(() => {
    ...
    const storyPanels = gsap.utils.toArray<HTMLElement>('.story-panel', container.current);
    const storySymbols = gsap.utils.toArray<HTMLElement>('.story-symbol', container.current);
